...
- Average retrieval latency: **1041.7 ms**
- Average token reduction vs full source context: **20.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.1 | 133 | 0.0% |  |
| E06 | semantic | PASS | 540.0 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1310.7 | 698 | 0.0% |  |
| E10 | short_term | PASS | 0.2 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1845.5 | 1426 | 0.0% |  |
| E03 | long_term | PASS | 1730.4 | 1436 | 0.0% |  |
| E04 | episodic | PASS | 268.6 | 153 | 30.8% |  |
| E05 | episodic | PASS | 269.0 | 144 | 34.8% |  |
| E07 | mixed | PASS | 2536.7 | 485 | 14.2% |  |
| E11 | semantic | PASS | 253.1 | 146 | 74.2% |  |
| E08 | long_term | PASS | 2704.8 | 1432 | 0.0% |  |
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which Python is preferred. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS. The user is currently debugging async HTTP, investigating connection pool, client lifecycle, and concurrency issues. They are identifying connection churn as the main issue, related to the ASYNC-FIX-20 incident.  Minh prefers Python and dislikes Java. When explaining code, short examples should be used. Python is preferred for personal demos like ORCHID-27, while TypeScript with NestJS is required for the BLUEBIRD-42 project's backend.  For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS; d`
